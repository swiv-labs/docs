...
<CardGroup cols={2}>
  ...
  <Card title="Private Execution (TEE / MagicBlock)" icon="lock">
  ...
  <Card title="Oracle Integration" icon="satellite">
    Integrates with oracles such as **Pyth** to source final outcome data at the exact pool deadline.
  </Card>
...
| **Privacy** | Off-chain computation via TEE / MagicBlock |
| **Trustless outcomes** | Oracle-sourced final values (e.g., Pyth) |
